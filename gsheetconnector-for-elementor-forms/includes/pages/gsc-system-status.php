...
<div class="wrap w-100 m-0">
  <div class="info-container inner-wrap w-100 bg-white p-40">
    ...
    $auth_method = get_option('elefgs_manual_setting');
    $auth = "";
    ...
    <div class="mb-20 mt-20">
      <button id="show-info-button" class="info-button">
    ...
    <div class="mb-20 mt-20">
      <button id="show-wordpress-info-button" class="info-button">
...
<div class="system-error shadow-box mt-40 p-30">
  <div class="error-container">
    <div class="error-log-head flex-wrap gap-20">
      <div class="heading mt-0 mb-0"><?php esc_html_e('Error Log', 'gsheetconnector-for-elementor-forms'); ?>
    </div>
    <div class="errorlog-button-list">
      ...
      <button type="button" class="button btn-logs clear-content-logs-elemnt">
  ...
  <!-- Log  Start-->
  <?php echo wp_kses_post($elementorForms_gs_tools_service->display_error_log());
  ?>
  <!--Log End -->
</div>
</div>