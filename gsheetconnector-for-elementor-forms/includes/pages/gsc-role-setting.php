...
<div class="gsc-pro-promo ml-15 mr-pro-15">
    ...
    <div class="gsc-pro-header">
        ...
        <div>
            ...
            <span
                class="gsc-pro-badge"><?php echo esc_html(__('Advanced options are available in PRO', 'gsheetconnector-for-elementor-forms')); ?></span>
        </div>
    </div>
...
<div class="gselef-role-settings" id="gsc-googlesheet">
    <div class="wrap w-100 m-0">
        <div class="inner-wrap w-100 bg-white p-40 blur-pro-feature">
            <div class="heading mt-0"><?php echo esc_html__('Access Management', 'gsheetconnector-for-elementor-forms'); ?>
            </div>
        ...
        <div class='para-heading fw-600 mb-20'>" . esc_html__('Plugin Access Control', 'gsheetconnector-for-elementor-forms') . "</div>";
                $selected_row .= "<div class='access-info mb-20'>" . esc_html__('Control who can access and manage the GSheetConnector plugin settings.', 'gsheetconnector-for-elementor-forms') . "</div>";
        ...
        <label class='role-label gsc-switch'> ";
            ...
            <div class="gsc-access-info">
                ...
                <ul>
                    <li><?php echo esc_html__('Control which user roles can access the GSheetConnector plugin', 'gsheetconnector-for-elementor-forms'); ?></li>
                    <li><?php echo esc_html__('Allow selected users to manage Google Sheets integration settings', 'gsheetconnector-for-elementor-forms'); ?>
                    </li>
                    <li><?php echo esc_html__('Restrict access to sensitive features like feeds, logs, and configurations', 'gsheetconnector-for-elementor-forms'); ?>
                    </li>
                    <li><?php echo esc_html__('Only enabled roles will see the plugin menu in the admin panel', 'gsheetconnector-for-elementor-forms'); ?>
                    </li>
                    <li><?php echo esc_html__('Recommended: Allow only Administrators and trusted Editors', 'gsheetconnector-for-elementor-forms'); ?>
                    </li>
                </ul>
            </div>
        </div>
