...
$header = admin_url('admin.php?page=gsheetconnector-elementor-config&tab=integration');
if (isset($_GET['code'])) {
...
?>
<div class="heading mt-0 mb-0"><?php echo esc_html(__('Google Sheets Integration for Elementor Forms', 'gsheetconnector-for-elementor-forms')); ?></div>
    ...
    <div class="oauth-method row justify-between shadow-box mt-40 p-30">
        <div class="col-7">
            <div class="existing-method mr-20">
                <div class="heading mt-0"> <?php echo esc_html(__('Google Account Connection', 'gsheetconnector-for-elementor-forms')); ?>
                    <span class="badge"><?php echo esc_html(__('Auto Setup', 'gsheetconnector-for-elementor-forms')); ?></span>
                </div>
                <p><?php echo esc_html(__('Sign in with your Google account to connect Elementor Forms with Google Sheets. Once connected, your data syncs based on your settings. Learn more in the documentation', 'gsheetconnector-for-elementor-forms')); ?>
                ...
                <div class="card-wp ele_apiesc_html_existing_setting">
                    <div class="elem-inside">
                        ...
                        $gselef_free_verify = get_option('elefgs_verify');

                        if (!empty($gselef_free_verify) && $gselef_free_verify == 'invalid-auth') {
                        ?>
                            <div class="gsc-msg gsc-error fw-400 gselef-permission-error text-dark pt-10 pb-10 manual-margin">
                            ...
                            ?>
                                        ...
                                        <div class="gsc-google-auth-card d-flex flex-wrap gap-20 justify-between align-center mt-30 mb-30">
                                            ...
                                            <div class="gsc-google-auth-right">
                                                <div class="gsc-connected-pill">
                                                    <span class="dot"></span>
                                                    <?php esc_html_e('Connected', 'gsheetconnector-for-elementor-forms-pro'); ?>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <?php } else { ?>
                                    <div class="gsc-msg gsc-error fw-400 text-dark text-center pt-10 pb-10 manual-margin">
                                        <?php echo esc_html(__('Something wrong ! Your Auth Code may be wrong or expired. Please deactivate and do Re-Authentication again. ', 'gsheetconnector-for-elementor-forms-pro')); ?>
                                    </div>
                        ...
                        ?>
                            <div class="button-container mt-20">
                                <button type="button" name="deactivate-log-ele" id="deactivate-log-ele"
                                    class="gsc-btn gsc-btn-gray btn deactivate-btn">
                                    <?php esc_html_e('Deactivate', 'gsheetconnector-for-elementor-forms-pro'); ?>
                                </button>

                                <span class="loading-sign-deactive"></span>
                            </div>
                        <?php } else {
                            // If no token, show input for code and Google sign-in button if code is empty
                            $redirct_uri = admin_url('admin.php?page=gsheetconnector-elementor-config&tab=integration');
                            $gsc_elementorform_auth_url = "https://oauth.gsheetconnector.com/index.php?client_admin_url=" . urlencode($redirct_uri) . "&plugin=woocommercegsheetconnector";


                        ?>
                            <?php if (empty($Code)) { ?>
                                <div class="gscfff-integration-box">
                                    <div class="gsc-google-auth-card d-flex flex-wrap gap-20 justify-between align-center mt-30 mb-30">

                                        <div class="gsc-google-auth-left d-flex flex-wrap align-center gap-15">
                                            <div class="gsc-google-icon">G</div>
                                            <div class="gsc-google-auth-text">
                                                <strong><?php echo esc_html__('Connect Your Google Account', 'gsheetconnector-for-elementor-forms-pro'); ?></strong>
                                                <p><?php echo esc_html__('Securely link your Google account to start syncing form entries automatically.', 'gsheetconnector-for-elementor-forms-pro'); ?></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="gsc-google-auth-right">
                                            <!-- SIGN IN WITH GOOGLE -->
                                            <a href="<?php echo esc_html($gsc_elementorform_auth_url); ?>"
                                                class="gsc-google-btn link-hover-white">
                                                <img
                                                    src="<?php echo esc_url(GS_CONN_ELE_URL); ?>/assets/img/g-logo.png"
                                                    alt="Google">
                                                <?php echo esc_html__('Sign in with Google', 'gsheetconnector-for-elementor-forms-pro'); ?>
                                            </a>
                                        </div>
                        ...
                        <?php if (!empty($_GET['code'])) { ?>
                            <div class="gscfff-integration-box">
                                <div class="gsc-google-auth-card d-flex flex-wrap gap-20 justify-between align-center mt-30 mb-30">
                                    <div class="gsc-google-auth-left d-flex flex-wrap align-center gap-15">
                                        <div class="gsc-google-icon">G</div>
                                        <div class="gsc-google-auth-text">
                                            <strong><?php echo esc_html__('Client Token', 'gsheetconnector-for-elementor-forms-pro'); ?></strong>
                                        </div>
                                    </div>
                                    <div class="gsc-google-auth-right">
                                        <div class="token-box-width-exist">
                                            <input type="password" id="ele-code" name="ele-code" class="gscefp-code form-control"
                            ...
                            <div class="button-container mt-30">
                                <button
                                    ...
                                    <?php echo esc_html__('Save Client Token', 'gsheetconnector-for-elementor-forms-pro'); ?>
                                </button>
        ...
        <div class="col-5">
            <div class="step-guide-col ml-20">
                ...
                <div class="gsc-slider-wrapper gselef-connection-guide-slider mt-30">
    ...
    <div id="gselef-confirm-deactive-popup-free" class="gselef-popup-overlay d-none">
        ...
        This will stop syncing your form entries.', 'gsheetconnector-for-elementor-forms'); ?>
            ...
            <div class="popup-actions d-flex justify-center gap-10">
                <button type="button" class="btn deactivate-btn" id="gselef-deactive-popup-free-cancel">
